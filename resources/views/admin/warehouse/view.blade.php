            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Ware House</a></li>
                        <li class="breadcrumb-item active">Detail :</li>
                    </ol>
                </div>
                <h4 class="page-title">Ware House Detail </h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="card-header bg-dark">
                                <div class="row">
                                    <div class="col-md-7">
                                        <h3 class="card_header"><i class="fa-solid fa-warehouse header_icon"></i>{{$view->wh_name}}
                                        </h3>
                                    </div>
                                    <div class="col-md-3 text-end"><a href="{{route('dashboard.warehouse')}}"
                                            class="btn btn-sm btn-primary btn_header ">
                                            <i class="fa-brands fa-servicestack btn_icon"></i>All Ware House</a>
                                    </div>
                                    <div class="col-md-2"><a href="{{url('dashboard/warehouse/edit/'.$view->wh_slug)}}" class="btn btn-sm btn-primary btn_header"><i class="uil-edit btn_icon"></i>Edit</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table border view_table">
                                ...
                                <tr>
                                    <td>Ware House Address</td>
                                    <td>:</td>
                                    <td>{{ $view->wh_address }}</td>
                                </tr>
                                <tr>
                                    <td>Ware House Number</td>
                                    <td>:</td>
                                    <td>{{ $view->wh_phone }}</td>
                                </tr>
                                <tr>
                                    <td>Ware House Created At</td>
                                    <td>:</td>
                                    <td>{{$view->created_at->format('D-M-Y | h:m:s A')}}</td>
                                </tr>
                                <tr>
                                    <td>Ware House Edited At</td>
                                    <td>:</td>
