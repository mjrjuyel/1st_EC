                        ...
                        <table class="table table-centered text-center ytable" id="">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center">WareHouse Number</th>
...
<div id="Delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="{{ url('/dashboard/warehouse/softdel') }}">
           @csrf
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-warning">
                    <h4 class="modal-title" id="primary-header-modalLabel">Product WareHouse</h4>
...
<script>
    $(function(){
        $('.ytable').DataTable({
            ...
            serverSide: true,
            ordering: false,
            ajax: "{{ route('dashboard.warehouse') }}",
            columns: [
                {
                    data: 'wh_name',
                    name: 'wh_name'
