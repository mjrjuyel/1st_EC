                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <li><a class="dropdown-item"
                                                            href="{{ url('/dashboard/subcategory/view/'.$data->subcat_slug) }}"><i
                                                                class="uil-table"></i>View</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ url('dashboard/subcategory/edit/'.$data->subcat_slug) }}"><i
                                                                class="uil-edit"></i>Edit</a></li>
                                                    <li>
                                                        <form action="{{url('/dashboard/subcategory/delete/'.$data->id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <hr>
                <form class="ps-3 pe-3" action="{{ route('dashboard.subcategory.store') }}" method="post"
