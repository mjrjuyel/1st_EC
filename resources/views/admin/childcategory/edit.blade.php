    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Child Category Edit :</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="card-header bg-dark">
                                <div class="row">
                                    ...
                                    <div class="col-md-2"><a
                                            href="{{ url('dashboard/childcategory/view/'.$edit->subcat_slug) }}"
                                            class="btn btn-sm btn-primary btn_header">
                            ...
                            <div class="mt-3">
                                <form class="ps-3 pe-3"
                                    action="{{ route('dashboard.childcategory.update') }}" method="post"
